...
public class MatchFilter {
    ...
    private us.kbase.reskesearchdemo.MatchValue timestamp;
    @JsonProperty("lookupInKeys")
    private Map<String, us.kbase.reskesearchdemo.MatchValue> lookupInKeys;
     ...
     */
    @JsonProperty("timestamp")
    public us.kbase.reskesearchdemo.MatchValue getTimestamp() {
        return timestamp;
    }
     ...
     */
    @JsonProperty("timestamp")
    public void setTimestamp(us.kbase.reskesearchdemo.MatchValue timestamp) {
        this.timestamp = timestamp;
    }

    public MatchFilter withTimestamp(us.kbase.reskesearchdemo.MatchValue timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    @JsonProperty("lookupInKeys")
    public Map<String, us.kbase.reskesearchdemo.MatchValue> getLookupInKeys() {
        return lookupInKeys;
    }

    @JsonProperty("lookupInKeys")
    public void setLookupInKeys(Map<String, us.kbase.reskesearchdemo.MatchValue> lookupInKeys) {
        this.lookupInKeys = lookupInKeys;
    }

    public MatchFilter withLookupInKeys(Map<String, us.kbase.reskesearchdemo.MatchValue> lookupInKeys) {
        this.lookupInKeys = lookupInKeys;
        return this;
    }
